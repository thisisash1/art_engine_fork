...
const findElement = (_layers, layerName, elementName) => {
  ...
  const foundElement = foundLayer.elements.filter(
    ...
    while (!done) {
      ...
      for (var i = 0; i < layer.elements.length; i++) {
        ...
        if (random < 0) {
          ...
          // if (layer.name === "Front") {
          //   if (name === "Orange Hoodie") {
          //     const possibleValues = ["1", "None"]; // 변경된 옵션 추가
          //     const randomIndex = Math.floor(
          //       Math.random() * possibleValues.length
          //     );
          //     const headwearValue = possibleValues[randomIndex];
          //     layerMap.set(
          //       "Headwear",
          //       findElement(_layers, "Headwear", headwearValue)
          //     );
          //   } else {
          //     const possibleValues = ["1", "2", "3", "4", "5", "6", "None"]; // 기존의 7개 옵션 추가
          //     const randomIndex = Math.floor(
          //       Math.random() * possibleValues.length
          //     );
          //     const headwearValue = possibleValues[randomIndex];
          ...
          // if (layer.name === "Front") {
          //   if (name == "Orange Hoodie") {
          //     layerMap.set("Headwear", findElement(_layers, "Headwear", "None"));
          //     layerMap.set("Front", findElement(_layers, "Front", "None"));
          //     layerMap.set("acc", findElement(_layers, "acc", "None"));
          //   } 단어 1개 추출
          // }
